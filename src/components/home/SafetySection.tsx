...
export function SafetySection() {
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden" style={{ background: "linear-gradient(135deg, #0f0f1a 0%, #1a1a2e 100%)" }}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <Link href="/cars" className="inline-flex items-center gap-2 text-white/50 hover:text-white transition-colors duration-200 text-sm">
          ...
          >
            <div className="relative">
              ...
              >
                <p className="text-white text-sm font-bold">Certified Gear</p>
                <p className="text-white/60 text-xs">International Standards</p>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute top-4 right-4 rounded-2xl bg-white/10 backdrop-blur px-4 py-2 border border-white/10"
              >
